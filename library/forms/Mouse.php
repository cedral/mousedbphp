...
//		$chimera_subform = new Zend_Form_SubForm();
		...
		$this->addElements( array($id, $user_id, $lastmodified, $assigned_id, $is_alive, $status, $born_on, $weaned_on, $terminated_on,
			$sex, $strain_id, $genotype, $generation, $protocol_id, $ear_mark, $chip, $cage_id ));
		...
		$this->addDisplayGroup( array('strain_id', 'genotype', 'generation', 'protocol_id', 'ear_mark', 'chip', 'cage_id' ), 'right' );
