...
class CommentController extends mdb_Controller {
	...
	public function newAction() {
		...
		if ($this->_request->isPost () && $this->_request->getParam('controller') == 'comment') {
			if ($form->isValid ( $formData ) && in_array($ref_table, array(Comments::STRAIN, Comments::MOUSE, Comments::LITTER, Comments::BREEDING_CAGE, Comments::WEANING_CAGE, Comments::TRANSFER, Comments::PROTOCOL, Comments::SEARCH))) {
				$comments = new Comments ( );
